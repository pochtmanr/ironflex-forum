...
interface ArticlesSortDropdownProps {
  currentSort: SortOption;
  onSortChange: (sort: SortOption) => void;
}

const ArticlesSortDropdown: React.FC<ArticlesSortDropdownProps> = ({ currentSort, onSortChange }) => {
...
export default React.memo(ArticlesSortDropdown);
